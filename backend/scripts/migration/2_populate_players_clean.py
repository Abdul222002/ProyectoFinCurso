"""
POBLACIN COMPLETA DE JUGADORES
...
def calcular_precio(ovr: int, position: Position) -> int:
    """Calcula el precio basado en OVR y posicin"""
    base_multiplier = {
        Position.GK: 0.8,
        Position.DEF: 0.9,
        Position.MID: 1.0,
...
def mapear_posicion_fifa(position_str: str) -> Position:
    """Mapea la posicin del FIFA al enum Position"""
...
# ==========================================
# FUNCIONES DE OBTENCIN DE DATOS
# ==========================================
...
def populate_players():
    """Funcin principal que puebla la base de datos"""
    ...
    try:
        ...
        print("\n" + "="*100)
        print(" POBLACIN DE JUGADORES COMPLETADA")
        print("="*100 + "\n")
